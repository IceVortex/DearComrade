...
public class Workplace : ABuilding
{
    ...
    public Workplace()
    {
        ...
        longDescription = "Workplaces are the backbone of the economy. They increase your approval by 30 and decrease the approval decay rate by 10%. Linking a house to workplaces increase the gold gained per citizen by 0.005. You can only link 2 houses to this building.";
