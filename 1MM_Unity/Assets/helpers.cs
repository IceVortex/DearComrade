...
public class helpers : MonoBehaviour {
    ...
    private string[] descriptionsList = { "Greetings! The goal of the game is to reach 100 approval and 3000 troops. However, if you reach -100 approval instead, you lose the game. Also, the game is turn based. To finish your turn click on the end turn button.", 
                                    ...
                                    "There are buildings which provide a flat amount of approval and also decrease the approval decay per turn, for example: Public Spaces or Educational Buildings. If you feel you are too low on approval, we suggest you start building these. These buildings also provide different types of bonuses when you link houses to them.", 
